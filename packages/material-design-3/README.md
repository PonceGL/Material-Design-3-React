...
| `SearchBar`        | Campo de búsqueda M3 persistente, con grow-on-focus y trailing actions | [Ver documentación →](https://github.com/PonceGL/Material-Design-3-React/blob/main/docs/components/SearchBar.md)        |
| `SearchView`       | Panel de búsqueda enfocada M3 — contained/divided, full-screen/docked  | [Ver documentación →](https://github.com/PonceGL/Material-Design-3-React/blob/main/docs/components/SearchView.md)       |
| `TextField`        | Campo de texto M3 con label flotante, validación y soporte multilínea  | [Ver documentación →](https://github.com/PonceGL/Material-Design-3-React/blob/main/docs/components/TextField.md)        |
